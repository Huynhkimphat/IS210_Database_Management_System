rem 
rem $Header: /forms456/prd/RCS/summit2a.sql,v 1.1 1995/05/12 03:22:11 rsadeghi Exp $ 
rem 
Rem NAME
Rem   summit2a.sql
Rem 
...
Rem 
Rem MODIFIED
Rem	nkochhar 	07/31/96 - Correction: NOT NULL constraint added to s_emp
Rem     dkramer     01/01/96 - Correction: customer Simms Athletics
Rem     smuench    05/02/93 -  Update for 4.0.8 
Rem     bbesser    04/30/93 -  Comments added to customers.
Rem     smuench    04/16/93 -  Source Control for Forms
Rem     gdurham	   03/30/93 -  Zip codes added to US addresses
Rem     gdurham	   03/15/93 -  Creation
